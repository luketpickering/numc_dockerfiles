...
if(NEUT_FOUND)
  ...
  if(${NEUT_VERSION} VERSION_EQUAL 5.4.0)
  ...
  message(STATUS "NEUT Found (Version: ${NEUT_VERSION}): ${NEUT_ROOT}")
  message(STATUS "    NEUT_SINGLE_VERSION: ${NEUT_SINGLE_VERSION}")
  message(STATUS "    NEUT_INCLUDE_DIRS: ${NEUT_INCLUDE_DIRS}")
  message(STATUS "    NEUT_DEFINES: ${NEUT_DEFINES}")
  message(STATUS "    NEUT_LIB_DIRS: ${NEUT_LIB_DIRS}")
  message(STATUS "    NEUT_LIBS: ${NEUT_LIBS}")
  message(STATUS "    NEUT_CLASS_SOS: ${NEUT_CLASS_SO_LIST}")
  message(STATUS "    NEUT_LINK_OPTIONS: ${NEUT_LINK_OPTIONS}")
  message(STATUS "    CERN_INCLUDE_DIR: ${CERN_INCLUDE_DIR}")
  message(STATUS "    CERN_LIB_DIR: ${CERN_LIB_DIR}")
  message(STATUS "    NEUT_CERN_LIBS: ${NEUT_CERN_LIBS}")
  ...
  if(NOT TARGET NEUT::IO)
      ...
      set_target_properties(NEUT::IO PROPERTIES
          ...
          INTERFACE_LINK_LIBRARIES "NEUT::Includes;-Wl,--no-as-needed;${NEUT_LIBS};${NEUT_CLASS_TARGET_LIST};-Wl,--as-needed;ROOT::RIO;${NEUT_CERN_LIBS};gfortran"
