...
BEGIN {
  ...
  # whether to keep particular isotopes
    tgtkeep[1000000010] = 1; # free neutron

    tgtkeep[1000010010] = 1; # H1
    tgtkeep[1000010020] = 1; # H2

    tgtkeep[1000060120] = 1; # C12
    tgtkeep[1000060130] = 1; # C13

    tgtkeep[1000080160] = 1; # O16
    tgtkeep[1000080170] = 1; # O17
    tgtkeep[1000080180] = 1; # O18

    tgtkeep[1000180360] = 1; # Ar36
    tgtkeep[1000180380] = 1; # Ar38
    tgtkeep[1000180390] = 1; # Ar39
    ...
    tgtkeep[1000822040] = 1; # Pb204
    tgtkeep[1000822060] = 1; # Pb206
    tgtkeep[1000822070] = 1; # Pb207
    tgtkeep[1000822080] = 1; # Pb208
}
